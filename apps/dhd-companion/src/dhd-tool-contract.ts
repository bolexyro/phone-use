...
const GUARD_REGIONS_GUIDANCE =
  "When guardRegions are available, include matching regions in dhd_observe and the corresponding action, or in the initial observation and first sequence step, only when that target must remain visually unchanged.";
